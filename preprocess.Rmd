...
```{r}
library(readr)
kills <- read_csv("https://raw.githubusercontent.com/simonmig10/M3/main/kills.csv")
```
...
```{r}
monsters <- read_csv("https://raw.githubusercontent.com/simonmig10/M3/main/monsters.csv")
```
